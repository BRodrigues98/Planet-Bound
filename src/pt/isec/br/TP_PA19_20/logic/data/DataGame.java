...
import pt.isec.br.TP_PA19_20.logic.data.planet.alien.BlackAlien;
import pt.isec.br.TP_PA19_20.logic.data.planet.alien.BlueAlien;
import pt.isec.br.TP_PA19_20.logic.data.planet.alien.GreenAlien;
import pt.isec.br.TP_PA19_20.logic.data.planet.alien.RedAlien;
...
public class DataGame implements Serializable {
    ...
    public int mine(){
        ...
        if(planet.getTimesMined() == planet.getNumResources()) {
            ...
            if(ship.getFuel() <= 0)
                return 3;
            else if(ship.getNumArtifacts() == 5){
                return 4;
            }
